        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                var options = {
                    ...
                    axisX: {
                        type: Chartist.FixedScaleAxis, divisor: 5, offset: 20,    
                        labelInterpolationFnc: function(value) {
            ...
            function getAndProcessData() {
                ...
                $.ajax({
                    dataType: "json",
                    url: "data/about.php?time=" + requestedTime.format(
            ...
            function loadGraphData() {
                var url = "data/graph-about.php?time=" + requestedTime.format(
                    "YYYY-MM-DD[T]HH-mm-00") + "&fields=EncT,CPUT";
                
                var xEnd = moment(requestedTime).tz(awsTimeZone).unix();
                var xStart = moment(requestedTime).subtract(5, "hour").tz(awsTimeZone).unix();
            ...
            <div id="menu">
                <div id="menu_items">
                    <div>
                        ...
                        <a class="menu_item" id="ami" href="about.php">About</a>
                    </div>
